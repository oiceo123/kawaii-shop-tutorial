...
func (b *updateProductBuilder) deleteOldImages() error {
	...
	if len(images) > 0 {
		...
		if err := b.fileUsecase.DeleteFileOnGcp(deleteFileReq); err != nil {
			return err
		}
	}
...
func (b *updateProductBuilder) getQueryField() []string {
...
func (en *updateProductEngineer) sumQueryFields() {
	...
	fields := en.builder.getQueryField()
