...
func (j *jwt) AccessExpiresAt() int      { return j.accessTokenExpiresAt }
func (j *jwt) RefreshExpiresAt() int     { return j.refreshTokenExpiresAt }
func (j *jwt) SetJwtAccessExpires(t int) { j.accessTokenExpiresAt = t }
func (j *jwt) SetJwtRefeshExpires(t int) { j.refreshTokenExpiresAt = t }
